...
class Template
{
    ...
    public function build($view, $data = array(), $return = FALSE)
    {
        ...
        $template['script_to_load'] = $this->_script_to_load;
    ...
    public function script_to_load($name)
    {
        $this->_script_to_load = $name; //array('name' => $name, 'uri' => $uri );
        return $this;
    }
