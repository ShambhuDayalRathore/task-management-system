            ...
            <div class="dropdown">
                <div class="user col align-self-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="sessions/signIn">Sign out</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-content-wrap sidenav-open d-flex flex-column">
        ...
        <div class="app-footer">
            ...
            <div class="footer-bottom border-top pt-3 d-flex flex-column flex-sm-row align-items-center">
                <a class="btn btn-primary text-white btn-rounded" target="_blank" href="https://themeforest.net/item/gull-bootstrap-laravel-admin-dashboard-template/23101970?ref=ui-lib" target="_blank">Buy
                    Gull HTML</a>
                <span class="flex-grow-1"></span>
